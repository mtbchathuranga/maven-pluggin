...
public class CarController {
	...
	@ApiOperation(value = "Get car", notes = "Get car using car id")
	@RequestMapping(value="/car/{car_id}", method= RequestMethod.GET, produces = "application/json")
	public Car getCar(
			@ApiParam(value = "car id", required = true, defaultValue = "1") @PathVariable("car_id")  String id)
			throws Exception {
	...
	@ApiOperation(value = "Add new car", notes = "See [Request JSON](#_save_car).")
